...
public class ActivityAction implements CeWsAction {
  ...
  private static class Request {
     ...
     */
    @Deprecated
    public Request setComponentQuery(String componentQuery) {
     ...
     */
    public Request setMaxExecutedAt(String maxExecutedAt) {
     ...
     * Example value: "2017-10-19T13:00:00+0200"
     */
    public Request setMinSubmittedAt(String minSubmittedAt) {
     ...
     * </ul>
     */
    public Request setOnlyCurrents(String onlyCurrents) {
     ...
     * Example value: "20"
     */
    public Request setPs(String ps) {
      this.ps = ps;
      return this;
    }
     ...
     * </ul>
     */
    public Request setStatus(List<String> status) {
      this.status = status;
      return this;
    }
